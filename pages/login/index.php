              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">
                    ...
                    <form action="/web-project/php/login.php" method="post" class="mx-1 mx-md-4">
                      <div class="d-flex flex-row align-items-center mb-4">
                        <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                          <label class="form-label" for="email">E-posta</label>
                          <input type="email" name="email" id="email" class="form-control" placeholder="ornek@ornek.com" />
                        </div>
                      </div>
                      ...
                      <div class="form-check d-flex flex-column justify-content-center mb-5">
                        <div class="remember-box">
                          <input class="form-check-input me-2" type="checkbox" id="rememberCheck" />
                          <label class="form-check-label" for="rememberCheck">Beni hatırla!</label>
                        </div>

                        <div class="register-box mt-4">
                          <label class="form-check-label" for="register">Henüz kayıt olmadınız mı?
                            <a class="link-danger" style="text-decoration: none;" href="/web-project/pages/register">Hemen kaydolun!</a>
                          </label>
                        </div>

                        <div class="forgot-box mt-2">
                          <label class="form-check-label" for="forgot">Şifrenizi mi unuttunuz?
                            <a class="link-danger" style="text-decoration: none;" href="#">Yenileyin!</a>
                          </label>
                        </div>
                      </div>

                      <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                        <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg">Giriş Yap</button>
                      </div>
                    </form>
                    </div>
                  </form>
